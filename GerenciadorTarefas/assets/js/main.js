...
function criaTarefa() {
    ...
    <input id="disabledInput recebe-tarefa" placeholder="${tarefa}" class="form-control" type="text" disabled>
...
function finalizaTarefa(id) {
    ...
    const input = document.querySelector('.lista').querySelector('.d-flex').querySelector('.form-control');
...
document.addEventListener('click', function(e) {
    ...
    if (el.classList.contains('btn-danger' || 'bi-trash')) {
        console.log('Apagar')
        lista.remove();
    }
})